...
function OverallReport() {
  ...
  const buildReport = () => {
    ...
    return reportShell(modeOptions.find((m) => m.value === mode)?.label ?? "Overall Report", body);
  };
